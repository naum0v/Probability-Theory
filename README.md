...
2. **Площадь стены** (по условию в 2 раза больше):  
   \[
   S_{\text{стены}} = 2 \cdot S_{\text{круга}} = 2\pi R^2
   \]

3. **Сторона квадратной стены**:  
   \[
   \text{side} = \sqrt{S_{\text{стены}}} = \sqrt{2\pi R^2} = R\sqrt{2\pi}
   \]

4. **Теоретическая вероятность** попадания в мишень при случайном броске в стену:  
   \[
   P_{\text{теор}} = \frac{S_{\text{круга}}}{S_{\text{стены}}} = \frac{\pi R^2}{2\pi R^2} = \frac{1}{2} = 0.5
   \]
