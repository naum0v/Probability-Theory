# Теория вероятностей
> **Примечание:** Нажимая на темы с номером, вы перейдете к файлу с решением в формате Jupyter Notebook (.ipynb).  
> Для удобства просмотра без запуска кода также доступны PDF-версии решений.
...
## [Тема 3.](3.ipynb) Применение условных вероятностей в анализе данных
...
<img width="1357" height="41" alt="image" src="https://github.com/user-attachments/assets/33cb61fb-6d3e-4c5c-a92e-1ae69b0f7396" />
...
## [Тема 4.](4.ipynb) Парадоксы в теории вероятностей
...
## [Тема 5.](5.ipynb) Законы распределения дискретных случайных величин
...
### Формулировки условий задач представлены в файле с решением.


## [Тема 6.](6.ipynb) Создание собственных распределений в Python
...
**Выбранная функция**, которая является плотностью вероятности: `0 при x<0, 8·x·e⁻⁴ˣ² при x≥0`


## [Тема 7.](7.ipynb) Исследование зависимости плотности от параметров НСВ в Python
...
### Теория и исследование логнормального распределения представлены в файле.
